        ...
        <footer className="text-gray-500 body-font">
            ...
            <div className="bg-gray-100">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-500 text-sm text-center sm:text-left">Copyright ©2023<a href="https://twitter.com/itsabdullahijaz" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">Abdullah Ijaz</a> | All Rights Reserved
                    </p>
