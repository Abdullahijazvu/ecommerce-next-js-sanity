const Newsletter = () => {
    return (
      <div className="relative text-center space-y-4 min-h-[20vh] md:h-[40vh] lg:min-h-[25rem] flex flex-col justify-center items-center text-gray-800">
        ...
        <div className="flex flex-wrap items-center justify-center">
          <input type="text" className="border border-gray-600 py-2 px-2 md:px-4 flex flex-grow w-80" placeholder="Enter Your Email Address" />
